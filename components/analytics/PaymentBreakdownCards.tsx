...
export function PaymentBreakdownCards({ breakdown }: PaymentBreakdownCardsProps) {
  const methodConfig: Record<string, { label: string; icon: string; colorClass: string }> = {
    CASH: { label: "Efectivo", icon: "💵", colorClass: "bg-green-50 text-green-700 dark:bg-green-950/30 dark:text-green-300 border-green-200 dark:border-green-800" },
    TRANSFER: { label: "Transferencia / MP", icon: "📱", colorClass: "bg-blue-50 text-blue-700 dark:bg-blue-950/30 dark:text-blue-300 border-blue-200 dark:border-blue-800" },
    CARD: { label: "Tarjeta", icon: "💳", colorClass: "bg-purple-50 text-purple-700 dark:bg-purple-950/30 dark:text-purple-300 border-purple-200 dark:border-purple-800" },
    UNCLASSIFIED: { label: "Sin clasificar", icon: "❓", colorClass: "bg-muted/50 text-muted-foreground border-muted" },
  };
