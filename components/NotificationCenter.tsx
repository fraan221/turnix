      ...
      <PopoverTrigger asChild>
        <Button variant="ghost" size="icon" aria-label="Abrir notificaciones">
          <div className="relative">
            ...
            {unreadCount > 0 && (
              <Badge className="absolute top-0 right-0 flex items-center justify-center w-5 h-5 p-0 text-xs font-bold text-white transform translate-x-1/2 -translate-y-1/2 bg-red-500 rounded-full animate-pulse">
